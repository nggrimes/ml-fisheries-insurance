...
range of potential indices. \textbf{?@sec-results} presents the primary
findings of the paper including the performance of all models. Future
steps and considerations for broader implementation of fishery index
insurance are outlined in Section~\ref{sec-discussion}.
